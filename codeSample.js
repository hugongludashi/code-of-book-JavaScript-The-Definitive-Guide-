//Anything following double slasshes is an English-language comment.
...
boo["fat"]               // => true: anothter way to acdess property values.
book.author = "Falnagan"; //Create new properties by assignment.
...
var points = [             // An array with 2 elements.
  {x:0, y:0},              // Each element is an oject.
  {x:1, y:1}
];
...
//uneaual, less than, greater than, and so on. They evaluate to true or false.
